...
SOURCE_ACCOUNTS = [ ("account1")] #A list of comma-separated, quote-enclosed Twitter handles of account that you'll generate tweets based on.
...
TEST_SOURCE = ".txt" #The name of a text file of a string-ified list for testing. To avoid unnecessarily hitting Twitter API.
                     #You can use the included testcorpus.txt, if needed.
